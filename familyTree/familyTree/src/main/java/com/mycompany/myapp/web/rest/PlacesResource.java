...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Places}.
 */
@RestController
@RequestMapping("/api")
public class PlacesResource {
    ...
    public PlacesResource(PlacesService placesService, PlacesRepository placesRepository) {
    ...
    public ResponseEntity<Places> createPlaces(@Valid @RequestBody Places places) throws URISyntaxException {
        ...
        Places result = placesService.save(places);
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/places/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<Places> partialUpdatePlaces(
        ...
        Optional<Places> result = placesService.partialUpdate(places);
    ...
    public ResponseEntity<List<Places>> getAllPlaces(Pageable pageable) {
        ...
        Page<Places> page = placesService.findAll(pageable);
    ...
    public ResponseEntity<Places> getPlaces(@PathVariable Long id) {
        ...
        Optional<Places> places = placesService.findOne(id);
